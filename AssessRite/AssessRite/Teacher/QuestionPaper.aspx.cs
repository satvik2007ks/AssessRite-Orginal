    ...
    public partial class QuestionPaper : System.Web.UI.Page
    {
        ...
        protected void rptQuestions_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                // lblQuestion.Text = Server.HtmlDecode(lblQuestion.Text);

                //HtmlDocument doc = new HtmlDocument();
                //doc.LoadHtml(lblQuestion.Text);
                //lblQuestion.Text = doc.DocumentNode.FirstChild.InnerHtml;

                //  lblQuestion.Text = lblQuestion.Text.Substring(3, lblQuestion.Text.Length - 7);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("QuestionPaper.aspx?TestId=" + Request.QueryString["TestId"].ToString() + "&Mode=View");
        }
    }
}