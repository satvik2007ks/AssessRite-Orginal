<%@ Page Title="" Language="C#" MasterPageFile="~/AssessRite/Admin/admin.Master" AutoEventWireup="true" CodeBehind="Question.aspx.cs" Inherits="AssessRite.Question" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
                ...
                <div class="card-body">
                        ...
                        <ContentTemplate>
                            <div class="row" style="margin-top: 10px;">
                                ...
                                <div class="col-md-4" style="text-align: center">
                                    <asp:Button ID="btnNew" runat="server" CssClass="btn btn-primary hide" Text="Clear and Add New" OnClick="btnNew_Click" />
                                </div>
                                <div class="col-md-4"></div>
                            </div>
                            <div class="form-group">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row marginbottom" style="margin-top:5px;">
                                <div class="col-md-4"></div>
                                <div class="col-md-4" style="text-align: center">
                    ...
                    <div id="divOptions" runat="server" style="display: none;">
                            ...
                            <FooterTemplate>
                                <div class="row" style="margin-top: 10px">
                                    ...
                                    <div class="col-md-6" id="divText" runat="server" style="display: none;">
                                        <asp:TextBox ID="txtOption" TextMode="MultiLine" runat="server" CssClass="form-control mytexteditorAns customheighttinymce" Style="height: 50px !important;" MaxLength="3500"></asp:TextBox>
                                    </div>
                                ...
                                <div class="row" id="divError1" runat="server" style="display:none">
                        ...
                        <div class="row" style="margin-bottom: 20px; margin-top: 20px">
                            ...
                            <asp:Label ID="lblUError" runat="server" Style="color: orange; margin:0 auto; font-size: small" Text="Note*:Image Options Cannot Be Updated. Please Delete and Upload New Images" Visible="false"></asp:Label>
                        </div>
                    </div>
