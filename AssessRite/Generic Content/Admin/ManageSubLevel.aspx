<%@ Page Title="" Language="C#" MasterPageFile="~/Generic Content/Admin/GCAdmin.Master" AutoEventWireup="true" CodeBehind="ManageSubLevel.aspx.cs" Inherits="AssessRite.Generic_Content.Admin.ManageSubLevel" %>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSubLevel" runat="server" Text="Class"></asp:Label>
