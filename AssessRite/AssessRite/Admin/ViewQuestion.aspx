<%@ Page Title="" Language="C#" MasterPageFile="~/AssessRite/Admin/admin.Master" AutoEventWireup="true" CodeBehind="ViewQuestion.aspx.cs" Inherits="AssessRite._3.Admin.ViewQuestion" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="breadcrumb">
        <h5 class="breadcrumbheading">View Questions</h5>
    </div>
    <div class="card mb-3">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#liViewQuestions').addClass('current-menu-item');
        ...
        function loadtable(defaultpage) {
            $.ajax({
                type: "POST",
                url: "../WebMethods/GetData.asmx/getQuestionsData",
