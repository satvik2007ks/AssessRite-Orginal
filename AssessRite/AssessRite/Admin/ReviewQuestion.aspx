<%@ Page Title="" Language="C#" MasterPageFile="~/AssessRite/Admin/admin.Master" AutoEventWireup="true" CodeBehind="ReviewQuestion.aspx.cs" Inherits="AssessRite._3.Admin.ReviewQuestion" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#liReviewQuestions').addClass('current-menu-item');
        ...
        function loadtable(defaultpage) {
            $.ajax({
                type: "POST",
                url: "../WebMethods/GetData.asmx/getQuestionsUnderReview",
