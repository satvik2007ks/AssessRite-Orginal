<%@ Page Title="" Language="C#" MasterPageFile="~/AssessRite/Admin/admin.Master" AutoEventWireup="true" CodeBehind="ManageDE.aspx.cs" Inherits="AssessRite._3.Admin.ManageDE" EnableEventValidation="false" %>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <asp:Button ID="btnDESave" runat="server" Text="Save" CssClass="btn btn-primary hide" ValidationGroup="vd" OnClick="btnDESave_Click" />
                </div>
                <div class="col-lg-7">
